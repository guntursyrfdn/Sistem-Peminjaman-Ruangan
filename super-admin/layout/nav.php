    ...
    <li class="nav-item">
      ...
      <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          ...
          <a class="collapse-item" href="index.php">Semua User</a>
        </div>
      </div>
    </li>
    <li class="nav-item">
      ...
      <div id="collapseUtilitiesTwo" class="collapse" aria-labelledby="headingUtilities"
        ...
        <div class="bg-white py-2 collapse-inner rounded">
          <a class="collapse-item" href="tambah-ruangan.php">Tambah Ruangan</a>
          <a class="collapse-item" href="ruangan.php">Semua Ruangan</a>
        </div>
      </div>
    </li>
